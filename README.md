...
| [TweetClaw](https://github.com/Xquik-dev/tweetclaw) ![Stars](https://img.shields.io/github/stars/Xquik-dev/tweetclaw?style=flat-square) | Xquik-dev | — | — | — | — | △ | OpenClaw plugin for X/Twitter research signals: search tweets, search tweet replies, scrape tweets, export followers, look up users, inspect media, monitor tweets, deliver webhooks, and use approval-reviewed post tweets or post tweet replies for sourced public conversation context. |
