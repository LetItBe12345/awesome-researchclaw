...
| [TweetClaw](https://github.com/Xquik-dev/tweetclaw) ![Stars](https://img.shields.io/github/stars/Xquik-dev/tweetclaw?style=flat-square) | Xquik-dev | — | — | — | — | △ | OpenClaw 的 X/Twitter 研究信号插件，支持 search tweets、search tweet replies、scrape tweets、follower export、user lookup、media inspection、monitors、webhooks，以及需审批的 post tweets / post tweet replies，用于补充公开讨论证据。 |
